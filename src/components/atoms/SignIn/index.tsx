...
type SignInProps = { userName: string | null };

export const SignIn: React.FC<SignInProps> = ({ userName }) => {
    return (
        <div className={styles.root}>
            <button className={styles.root__loginicon}>
                <svg
                    width="20"
                    height="22"
                    viewBox="0 0 20 22"
                ...
                {userName && (
                    <div className={styles.root__authorised}>
                        <button className={styles.root__btn_auth}>
                            {userName}
                        </button>
                    </div>
                )}
